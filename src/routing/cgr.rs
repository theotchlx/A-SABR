...
#[macro_export]
macro_rules! create_cgr_variant {
    ($struct_name:ident, $volume_aware:ident) => {
        ...
        impl<
                ...
                P: Pathfinding<NM, CM>,
                S: RouteStorage<NM, CM>,
            > Router<NM, CM> for $struct_name<NM, CM, P, S>
        {
            fn route(
                &mut self,
                source: NodeID,
            ...
            fn route_unicast(
                ...
                loop {
                    ...
                    if let Some(route) = Route::from_tree(tree, dest) {
                        ...
                        let dry_run = dry_run_unicast_path(
                            bundle,
                            curr_time,
                            route.source_stage.clone(),
                            true,
...
create_cgr_variant!(Cgr, false);
create_cgr_variant!(VolCgr, true);
